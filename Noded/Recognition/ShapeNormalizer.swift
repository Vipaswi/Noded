/**
    ...
    Date: 2024-06-01
    Description: A struct responsible for normalizing shapes, which includes scaling, translating,
    and rotating strokes to a standard form for recognition.
*/
...
struct ShapeNormalizer {
    ...
    static func rotateBy(stroke: Stroke, angle: Double) -> Stroke {
        ...
        for strokePoint in stroke.strokePoints {
            ...
            rotatedPoints.append(StrokePoint(point: newPoint, timestamp: strokePoint.timestamp))
        }
    ...
    static func scaleTo(stroke: Stroke, size: Double) -> Stroke {
        ...
        for strokePoint in stroke.strokePoints {
            ...
            scaledPoints.append(StrokePoint(point: newPoint, timestamp: strokePoint.timestamp))
        }
    ...
    static func translateTo(stroke: Stroke, target: Point2D) -> Stroke {
        ...
        for strokePoint in stroke.strokePoints {
            ...
            translatedPoints.append(StrokePoint(point: newPoint, timestamp: strokePoint.timestamp))
        }
